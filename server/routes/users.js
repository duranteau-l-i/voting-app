...
router.post('/register', (req, res, next) => {
  ...
  users.findOneAndUpdate({'email': userEmail}, newUser, { upsert: true }, (err, docs) => {
      console.log(docs);
      if(docs === null) {
...
router.post('/change-password', (req, res, next) => {
  ...
  const userNewPassword = req.body.newPassword;
    ...
    users.findOneAndUpdate({'name': userName, 'password': userCurrentPassword}, {'$set': {
      'password': userNewPassword}}, {new: true}, (err, docs) => {
        if(docs !== null) {
